...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Crie seu Perfi') }}</div>

                <div class="card-body">
                    <form action="/salvarCriacaoPerfil" method="POST" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="input-group mb-3">
                            ...
                            <textarea class="form-control ms-3" name='sobre' id="exampleFormControlTextarea1" rows="3"></textarea>
                        </div>
